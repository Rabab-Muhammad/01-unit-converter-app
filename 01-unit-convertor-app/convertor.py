...
st.markdown(
    ...
    # .stButton{         background: linear-gradient(45deg, #0b5394, #351c75)         color: white;         font-size:18px;         padding:10px 20px;         border-radius:10px;         transtion:0.3s;         box-shadow:0px 5px 15px rgba(0,201,255,0.4);      }     .stButton>button:hover{         background: linear-gradient(45deg, #92fe9d, #00c9ff);         transform: scale(1.05);         color:black;      } 
    # }
    .result-box {
        font-size: 20px;
        font-weight: bold;
...
# 🖋️ Footer
st.markdown("<div class='footer'>🧠 Created with ❤️ by Rabab Muhammad</div>", unsafe_allow_html=True)
